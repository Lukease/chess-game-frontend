...
export const addPieceToDataBase = (gameArrangement: Array<Piece>, currentFieldImg: any, nameOfFigure: string, currentColumnNumber: number, currentFieldNumber: number, colorOfFigure: string) => {

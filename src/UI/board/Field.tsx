...
import {CoordinateService, GameService, HistoryService, MovingService} from '../../game/suppliers'
...
export class Field extends React.Component<any, any> {
    ...
    constructor({rowNumber, id, columnNumber, piece, key, color, gameService, movingService, historyService}: TField) {
        super({rowNumber, id, columnNumber, piece, key, color, gameService, movingService, historyService})
